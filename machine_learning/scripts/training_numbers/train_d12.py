...
full_dataset = DiceDataset("../../dataset/augmented", dice_type="d12", transform=transform)
...
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.title('d12 Dice Classification Accuracy')
plt.legend()
plt.grid(True)
plt.show()
...
plt.ylabel("True")
plt.title("Confusion Matrix for d12 Dice")
plt.tight_layout()
plt.show()
...
model_path = os.path.join(model_dir, "d12_classifier.pth")
